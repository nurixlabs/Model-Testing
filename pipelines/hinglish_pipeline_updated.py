...
# ==============================================================================
# Flexible dataset entry points for Hinglish/Hindi
# ==============================================================================
...
def process_hinglish(
    ...
    """
    Unified Hinglish entrypoint. Supports:
      • Custom CSV (default): columns Key|audio_path, ground_truth|Transcription
    ...
    if source == 'csv' and (csv_path or dataset_key == 'custom-csv'):
        ...
        return process_hinglish_csv(model_name, model_config, csv_path, output_dir, language=language)
